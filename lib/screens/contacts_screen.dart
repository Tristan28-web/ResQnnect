      ...
      body: _isLoading 
        ...
        : ListView(
            ...
            children: [
              ...
              const SizedBox(height: 32),
              _buildContactCategory(context, 'Catanduanes Responders (Direct Line)'),
              _buildContactTile(context, 'PDRRMO Catanduanes (Disaster Ops)', '0928-507-6842', Icons.emergency_rounded),
              _buildContactTile(context, 'BFP Virac / Catanduanes Fire Station', '0919-994-5226', Icons.fire_truck_rounded),
              _buildContactTile(context, 'Catanduanes Police Provincial Office', '0998-598-6014', Icons.local_police_rounded),
              _buildContactTile(context, 'MDRRMO Virac Command', '0949-993-8551', Icons.shield_rounded),
              const SizedBox(height: 32),
              _buildContactCategory(context, 'Public Hospitals & Medical Centers'),
              _buildContactTile(context, 'Eastern Bicol Medical Center (EBMC)', '052-811-1254', Icons.local_hospital_rounded),
              _buildContactTile(context, 'Philippine Red Cross - Catanduanes', '0920-953-2945', Icons.medical_services_rounded),
