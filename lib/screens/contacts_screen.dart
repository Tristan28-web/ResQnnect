      ...
      body: _isLoading 
        ...
        : ListView(
            ...
            children: [
              ...
              const SizedBox(height: 32),
              _buildContactCategory(context, 'Emergency Services (Direct Lines)'),
              _buildContactTile(context, 'National Emergency Hotline', '911', Icons.emergency_rounded),
              _buildContactTile(context, 'Bureau of Fire Protection (BFP)', '160', Icons.fire_truck_rounded),
              _buildContactTile(context, 'Philippine National Police (PNP)', '117', Icons.local_police_rounded),
              _buildContactTile(context, 'Disaster Risk Reduction Office (DRRMO)', '134', Icons.shield_rounded),
              const SizedBox(height: 32),
              _buildContactCategory(context, 'Medical & Health Services'),
              _buildContactTile(context, 'Philippine Red Cross Emergency', '143', Icons.medical_services_rounded),
              _buildContactTile(context, 'Department of Health Emergency Hotline', '1555', Icons.local_hospital_rounded),
